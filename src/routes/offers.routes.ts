 ...
 *     description: Permite a un estudiante postularse a una oferta de trabajo. Solo accesible para usuarios con rol ESTUDIANTE.
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - name: id
 ...
 *                 type: string
 *                 maxLength: 1000
 *                 example: "Estoy muy interesado en esta posición. Tengo experiencia en React y TypeScript como se solicita en la oferta."
 *                 description: "Mensaje personalizado del postulante (opcional)"
 *               cvUrl:
 *                 type: string
 *                 format: uri
 *                 example: "https://drive.google.com/file/d/123abc/view"
 *                 description: "URL del CV específico para esta postulación (opcional)"
 *     responses:
 *       201:
 ...
 *                 message:
 *                   type: string
 *                   example: "Postulación enviada exitosamente"
 *                 data:
 *                   $ref: '#/components/schemas/Application'
 *       400:
 *         description: Errores de validación o lógica de negocio
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 *             examples:
 *               already_applied:
 *                 summary: Ya se postuló a esta oferta
 *                 value:
 *                   success: false
 ...
 *                 value:
 *                   success: false
 *                   message: "Esta oferta ya no acepta postulaciones"
 *                   error: "OFFER_CLOSED"
 *       401:
 *         $ref: '#/components/responses/UnauthorizedError'
 *       403:
 *         description: Solo estudiantes pueden postularse
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 *             example:
 *               success: false
 *               message: "Solo estudiantes pueden postularse a ofertas"
 *               error: "FORBIDDEN"
 *       404:
 *         description: Oferta no encontrada o perfil de estudiante no encontrado
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
...
router.get('/:id/applications', 
  ...
  idValidation,
  searchValidation,
  offersController.getOfferApplications.bind(offersController)
);

/**
 * @swagger
 * /api/offers/student/my-applications:
 *   get:
 *     tags: [Offers]
 *     summary: Obtener mis postulaciones
 *     description: Permite a un estudiante ver todas sus postulaciones. Solo accesible para usuarios con rol ESTUDIANTE.
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - name: page
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 *       403:
 *         description: Solo estudiantes pueden ver sus postulaciones
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 *             example:
 *               success: false
 *               message: "Solo estudiantes pueden ver sus postulaciones"
 *               error: "FORBIDDEN"
 *       500:
 *         $ref: '#/components/responses/InternalServerError'
 */
